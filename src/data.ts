...
export const DRINKS_CATALOG = [
  ...
  { id: 9, title: "Eliksir z Pyłku Pszczelego", effect: "Bomba witaminowa", when: "Poranek/wieczór", ingredients: "pyłek pszczeli, woda, miód", icon: Shield, color: "text-yellow-500", bg: "bg-yellow-500/10", category: "DOWOLNA PORA" },
  { id: 10, title: "Woda Chia Fresca", effect: "Przedłużone nawodnienie", when: "Cały dzień", ingredients: "nasiona chia, woda, cytryna", icon: Droplet, color: "text-blue-500", bg: "bg-blue-500/10", category: "DOWOLNA PORA" }
];
