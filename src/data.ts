...
export const DRINKS_CATALOG = [
  ...
  { id: 6, title: "Kakao Adaptogenne", effect: "Redukcja stresu", when: "Popołudnie", ingredients: "surowe kakao, adaptogeny, napój roślinny (mleko A2 Bio)", instructions: "W rondelku lekko podgrzej napój roślinny. Dodaj płaską łyżkę surowego kakao i porcję adaptogenów (np. Ashwagandha). Rozmieszaj dokładnie spieniaczem.", icon: CupSoda, color: "text-orange-400", bg: "bg-orange-400/10", category: "W TRAKCIE DNIA" },
  
  // CATEGORY 3: WIECZÓR (Wyciszenie i Sen)
  { id: 7, title: "Złote Mleko Kardamonowe", effect: "Sen i relaks", when: "20:00", ingredients: "mleko roślinne (mleko A2 Bio), kurkuma, cynamon, kardamon, olej kokosowy", instructions: "W rondelku połącz mleko z kurkumą, cynamonem, kardamonem i opcjonalnie odrobiną oleju kokosowego. Podgrzewaj na małym ogniu przez ok. 5 minut, mieszając i nie doprowadzając do wrzenia.", timer: 300, icon: Beaker, color: "text-amber-400", bg: "bg-amber-400/10", category: "WIECZÓR" },
