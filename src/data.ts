...
export const SHOPPING_BASE = [
  ...
  { name: "Różeniec Górski (Rhodiola)", category: "Adaptogeny", icon: Target },
  { name: "Cordyceps", category: "Adaptogeny", icon: Zap },
  { name: "Maca", category: "Adaptogeny", icon: Sparkles },
...
export const DRINKS_CATALOG = [
  ...
  { 
    id: 1, 
    title: "Poranny Izotonik", 
    effect: "Nawodnienie na start", 
    when: "07:00 po wstaniu", 
    ingredients: "300ml ciepłej wody, sól kłodawska, ocet jabłkowy", 
    adaptogen: "1/2 łyżeczki Różeńca Górskiego (Rhodiola) dla zwiększenia odporności na stres już od pierwszych minut poranka.",
    instructions: "Do szklanki wlej 300ml ciepłej wody, dodaj szczyptę soli kłodawskiej i łyżkę octu jabłkowego. Dokładnie wymieszaj i pij na czczo.", 
    icon: Waves, 
    category: "PORANEK" 
  },
  { 
    id: 2, 
    title: "Zielona Matcha Latte", 
    effect: "Skupienie 3-4 h", 
    when: "09:00 start pracy", 
    ingredients: "matcha, woda max 80°C, mleko roślinne (mleko A2 Bio)", 
    adaptogen: "Wybierz 1 lub połącz:",
    adaptogenOptions: [
      "Opcja A (Skupienie i usuwanie mgły mózgowej):\n1 płaska łyżeczka Soplówki jeżowatej (Lion's Mane).",
      "Opcja B (Stresujący deadline):\n1/2 łyżeczki Różeńca Górskiego (Rhodiola)."
    ],
    instructions: "Wsyp łyżeczkę matchy do miseczki. Dolej niewielką ilość wody (max 80°C) i dynamicznie wymieszaj miotełką (chasen) lub spieniaczem. Podgrzej mleko, opcjonalnie spień je, i zalej przygotowaną matchę.", 
    timer: 120, 
    icon: Leaf, 
  ...
  { 
    id: 11, 
    title: "Rytuał Kawowy \"High Performance\"", 
    effect: "Maksymalne skupienie i stabilna energia", 
    when: "10:00", 
    ingredients: "Dobra kawa z ekspresu lub drippera (np. V60), Opcjonalnie: odrobina masła klarowanego lub oleju kokosowego dla stabilnej energii, Szczypta kardamonu (łagodzi kwasowość żołądka)", 
    adaptogen: "Możesz połączyć oba!",
    adaptogenOptions: [
      "1/2 łyżeczki Soplówki jeżowatej (Lion's Mane).",
      "1/2 łyżeczki Cordycepsu (jeśli po pracy planujesz aktywność fizyczną lub spacer NEAT)."
    ],
    instructions: "Zaparz filiżankę gorącej czarnej kawy i przelej ją do blendera lub wysokiego naczynia. Dodaj łyżeczkę masła klarowanego (lub oleju kokosowego), szczyptę kardamonu oraz 1/2 łyżeczki wybranego adaptogenu (Soplówka jeżowata lub Cordyceps). Całość dokładnie zmiksuj blenderem lub ręcznym spieniaczem do uzyskania gładkiej emulsji z jasną pianką i wypij minimum 90-120 minut po przebudzeniu (nigdy na czczo).", 
    icon: Coffee, 
  ...
  { 
    id: 6, 
    title: "Kakao Adaptogenne", 
    effect: "Redukcja stresu", 
    when: "Popołudnie", 
    ingredients: "surowe kakao, napój roślinny (mleko A2 Bio)", 
    adaptogen: "Synergia relaksu - połącz je:",
    adaptogenOptions: [
    ...
    instructions: "W rondelku lekko podgrzej napój roślinny. Dodaj płaską łyżkę surowego kakao i porcję adaptogenów (np. Ashwagandha). Rozmieszaj dokładnie spieniaczem.", 
    icon: CupSoda, 
    color: "text-orange-400", 
    bg: "bg-orange-400/10", 
    category: "W TRAKCIE DNIA" 
  },
  
  // CATEGORY 3: WIECZÓR (Wyciszenie i Sen)
  { 
    id: 7, 
    title: "Złote Mleko Kardamonowe", 
    effect: "Sen i relaks", 
    when: "20:00", 
    ingredients: "mleko roślinne (mleko A2 Bio), kurkuma, cynamon, kardamon, olej kokosowy",
    adaptogen: "1 płaska łyżeczka Ashwagandhy. To potężny reduktor kortyzolu, który w połączeniu z ciepłym mlekiem i kurkumą działa jak biologiczny wyłącznik stresu.", 
    instructions: "W rondelku połącz mleko z kurkumą, cynamonem, kardamonem i opcjonalnie odrobiną oleju kokosowego. Podgrzewaj na małym ogniu przez ok. 5 minut, mieszając i nie doprowadzając do wrzenia.", 
    timer: 300, 
    icon: Beaker, 
