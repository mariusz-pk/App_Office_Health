...
export const DRINKS_CATALOG = [
  ...
  { id: 6, title: "Kakao Adaptogenne", effect: "Redukcja stresu", when: "Popołudnie", ingredients: "surowe kakao, adaptogeny, napój roślinny", instructions: "W rondelku lekko podgrzej napój roślinny. Dodaj płaską łyżkę surowego kakao i porcję adaptogenów (np. Ashwagandha). Rozmieszaj dokładnie spieniaczem.", icon: CupSoda, color: "text-orange-400", bg: "bg-orange-400/10", category: "W TRAKCIE DNIA" },
